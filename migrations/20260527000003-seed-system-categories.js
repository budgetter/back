...
const SYSTEM_CATEGORIES = [
  { translationKey: "income", name: "Income", type: "income", icon: "💰", color1: "#10b981", sortOrder: 0, children: [
  ...
  { translationKey: "housing", name: "Housing", type: "expense", icon: "🏠", color1: "#f59e0b", sortOrder: 1, children: [
  ...
  { translationKey: "food_dining", name: "Food & Dining", type: "expense", icon: "🍔", color1: "#3b82f6", sortOrder: 2, children: [
  ...
  { translationKey: "transport", name: "Transport", type: "expense", icon: "🚗", color1: "#8b5cf6", sortOrder: 3, children: [
  ...
  { translationKey: "shopping", name: "Shopping", type: "expense", icon: "🛍️", color1: "#ec4899", sortOrder: 4, children: [
  ...
  { translationKey: "health", name: "Health", type: "expense", icon: "💊", color1: "#ef4444", sortOrder: 5, children: [
  ...
  { translationKey: "entertainment", name: "Entertainment", type: "expense", icon: "🎬", color1: "#f472b6", sortOrder: 6, children: [
  ...
  { translationKey: "education", name: "Education", type: "expense", icon: "📚", color1: "#06b6d4", sortOrder: 7, children: [
  ...
  { translationKey: "financial", name: "Financial", type: "expense", icon: "💳", color1: "#6366f1", sortOrder: 8, children: [
  ...
  { translationKey: "subscriptions", name: "Subscriptions", type: "expense", icon: "📱", color1: "#14b8a6", sortOrder: 9, children: [
  ...
  { translationKey: "personal", name: "Personal", type: "expense", icon: "🧑", color1: "#a855f7", sortOrder: 10, children: [
  ...
  { translationKey: "other", name: "Other", type: "expense", icon: "❓", color1: "#6b7280", sortOrder: 11, children: [
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const [existing] = await queryInterface.sequelize.query(
      "SELECT COUNT(*) as cnt FROM categories WHERE isSystem = true",
    ...
    for (const parent of SYSTEM_CATEGORIES) {
      ...
      await queryInterface.bulkInsert('categories', [{
        id: parentId, name: parent.name, type: parent.type, icon: parent.icon,
        parentId: null, isSystem: true, sortOrder: parent.sortOrder,
        translationKey: parent.translationKey, color1: parent.color1, color2: null,
        description: null, createdAt: now, updatedAt: now,
      }]);
      for (let i = 0; i < parent.children.length; i++) {
        const child = parent.children[i];
        await queryInterface.bulkInsert('categories', [{
          id: uuidv4(), name: child.name, type: parent.type, icon: child.icon,
          parentId, isSystem: true, sortOrder: i,
          translationKey: child.translationKey, color1: parent.color1, color2: null,
          description: null, createdAt: now, updatedAt: now,
        }]);
      }
    }
